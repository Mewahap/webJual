            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="berat" min="0" class="form-control" placeholder="Berat dalam satuan gram" value="<?= set_value('harga') ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <textarea name="deskripsi" class="form-control" id="" rows="5" placeholder="Deskripsi Barang"><?= set_value('deskripsi') ?></textarea>
                    </div>
