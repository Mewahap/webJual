...
<div>
<a href="<?php echo base_url("LapPdf_Transaksi.php"); ?>"><input type="button" style="background: red;" value="Export PDF"></a><span>
                        <a href="<?php echo base_url("export.php"); ?>"><input type="button" style="background: green;" value="Export EXCEL"></a><hr>
            <?php echo form_close() ?>
                        </div> 